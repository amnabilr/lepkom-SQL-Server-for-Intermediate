CREATE database perusahaan_10119723;

USE perusahaan_10119723;
...
from EMP where SAL > (select AVG(sal) from EMP where JOB = 'analyst')
and JOB <>'clerk'

--3 
select EMP.ENAME, EMP.EMPNO, DEPT.LOC, EMP.JOB, EMP.SAL 
...
from EMP, DEPT
where EMP.SAL >= (select SAL from EMP where ENAME = 'blake')
